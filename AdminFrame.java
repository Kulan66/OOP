...
public class AdminFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCreateHR.setBackground(new java.awt.Color(0, 51, 153));
        btnCreateHR.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnCreateHR.setForeground(new java.awt.Color(255, 255, 255));
        btnCreateHR.setText("Create HR Account");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(49, 49, 49)
                .addComponent(btnCreateHR, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCreateHRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateHRActionPerformed
        Create_HRFrame obj = new Create_HRFrame();
        obj.show();
        this.dispose();
